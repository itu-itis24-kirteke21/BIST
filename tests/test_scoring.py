...
class TestTechnicalScore:
    ...
    @pytest.mark.parametrize(
        "macd, macd_hist, expected_points",
        [
...
class TestFundamentalScore:
    ...
    def test_pe_scoring_brackets(self, pe, expected_points):
        ...
        score = calculate_fundamental_score(
            pe=pe, pb=1.2, beta=1.0, profit_margin=25.0, roe=22.0, debt_equity=20.0, rec_mean=1.2
        )
    ...
    def test_roe_scoring_brackets(self, roe, expected_points):
        ...
        score = calculate_fundamental_score(
            pe=6.0, pb=1.2, beta=1.0, profit_margin=25.0, roe=roe, debt_equity=20.0, rec_mean=1.2
        )
