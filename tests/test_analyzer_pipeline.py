...
class TestAnalyzeStock:
    ...
    def test_analyze_stock_success(self, sample_stock_meta, sample_history_df, sample_info_positive, mock_ticker_factory):
    ...
    def test_sentiment_classification(self, sample_stock_meta, sample_history_df, sample_prices_downtrend, sample_info_positive, sample_info_negative, mock_ticker_factory):
...
class TestRunAnalysis:
    ...
    def test_run_analysis_creates_json_and_sorts(self, sample_stocks_dict, sample_history_df, sample_info_positive, sample_info_neutral, mock_ticker_factory, tmp_path):
        ...
        with patch('yfinance.Ticker', side_effect=mock_ticker_dispatcher), \
